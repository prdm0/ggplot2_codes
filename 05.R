...
p2 <- p1 + stat_function(fun = dnorm, args = list(mean = 0, sd = 1), mapping = aes(color = "normal")) + 
...
p4 + scale_fill_manual(breaks = c("rejeicao1", "rejeicao2", "areaqualquer"),
                       values = c("gray", "gray", "red"), name = "Areas")